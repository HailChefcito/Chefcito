...
<?php   
  ...
  while($mostrar = mysqli_fetch_array($querychefcito))
  {
    ...
    ";
    echo "<td ><a class='btn btn-success'href=\"platos/modificar.php?idPlatos=$mostrar[idPlatos]\">Modificar</a>";
    echo"<br>";
    echo "<td><a class='btn btn-success'href =\"platos/eliminar.php?idPlatos=$mostrar[idPlatos]\"onClick=\"return confirm('¿Estas seguro de eliminar a $mostrar[nombrePlatos]?')\">Eliminar</a></td>" ;
    echo"</table>";
