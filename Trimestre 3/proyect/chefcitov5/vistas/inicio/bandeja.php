...
if(isset($_SESSION["items_bandeja"]))
{
    ...
    <tr>
        ...
        <th ><a href="inicio.php?action=default">Limpiar</a></th>
    </tr>	
    <?php		
    ...
    ?>
            <tr>
                ...
                <td><a href="inicio.php?action=delete&eliminarcode=<?php echo $plato["id_plato"]; ?>">Eliminar</a></td>
            </tr>
    <?php
    ...
    <tr>
        ...
        <td><a href="inicio.php?action=pay">Pagar</a></td>
    </tr>
