...
{ $ntabla=0;
  foreach($array_platos as $i=>$k)
  {
      ...
      <center>
        <div class='card mb-3' style='max-width: 70%;'>
          <div class='row g-0'>
            ...
            <div class='col-md-8'>
              <div class='card-body'>
                <h5 class='card-title'><h3>".$array_platos[$i]['nombrePlatos']."</h3></h5>
    ...
    ";
    echo "<td><input class='btn btn-outline-success' type='number' name='txtcantidad' value='1'  />";
 
    echo "<td><input class='btn btn-outline-success' type='submit' value='Agregar' /></td>" ;
    echo "</center>";
    echo"</table>";
    echo "</form>";
  }
