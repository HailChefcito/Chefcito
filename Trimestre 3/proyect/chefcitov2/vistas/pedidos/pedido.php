                ...
                <tr>
                    ...
                    if(isset($_POST['btnbuscar']))
                        {   
                            ...
                            $queryMostrar=mysqli_query($conn, "SELECT idPedidos, numeroTelefono, fechaPedido, horaPedido, valorPedido FROM pedidos WHERE idPedidos LIKE '".$buscar."'");
                        }
                    else
                        {
                            $queryMostrar = mysqli_query($conn, "SELECT idPedidos, numeroTelefono, fechaPedido, horaPedido, valorPedido FROM pedidos ORDER BY idPedidos ASC");
                        }
                    ...
                    while($mostrar = mysqli_fetch_array($queryMostrar))
                        {
                            ...
                            $numTelefono = $mostrar['numeroTelefono'];
