...
<?php   
  ...
  while($mostrar = mysqli_fetch_array($querychefcito))
  {
    ...
    echo "
      <center>
        <div class='card mb-3' style='max-width: 70%;'>
          <div class='row g-0'>
            <div class='col-md-4'>
              <img src='imagenes/caffe.jpg' class='img-fluid rounded-start' alt='...'>
            </div>
            <div class='col-md-8'>
              <div class='card-body'>
    ...
    ";
    echo "<td style='width=26%'><a href=\"modificar.php?idPlatos=$mostrar[idPlatos]\">Modificar</a>";
    echo "<th><a href =\"eliminar.php?idPlatos=$mostrar[idPlatos]\"onClick=\"return confirm('¿Estas seguro de eliminar a $mostrar[nombrePlatos]?')\">Eliminar</a></th>" ;
    echo"</table>";
