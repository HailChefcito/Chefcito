<button class="btn btn-primary" style="margin-left: 450px; width: 15%;" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><img class='ic' src='../resources/informacion.png'alt=''></button>
    ...
    <div class="offcanvas-body">
        ...
        <h2>informacion del cliente</h2>
            ...
            <div class="usuario">  
                ...
                <br><center>
                    <label align="center">Teléfono:<?php echo $userData['numeroTelefono']; ?><br></label>
                    ...
                    <p></p>
                    <center>
                        <a style="margin-left:6%; margin-bottom:5px;" type="button" class='btn btn-success'  href="../vistas/modificarUsuario.php">Modificar</a>
                        <a style="margin-left:15px; margin-bottom:5px;" class='btn btn-success' href="cerrarSesion/logOut.php" onClick="Javascript: return confirm('¿Seguro en cerrar secion?')">cerrar sesion</a>
                     </center>
            ...
            <center>
                ...
                <?php           echo"<td colspan='3'><a class='btn btn-outline-success' style='' href =\"inicio/registarsuge.php?emailUsuario=$userData[emailUsuario]\"onClick=\"return confirm('¿Vas a subir un sugerencia $userData[emailUsuario]?')\">Agregar sugerencia :)</a></td>";
