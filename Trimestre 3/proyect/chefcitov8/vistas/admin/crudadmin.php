...
<?php 
  ...
  while($mostrar = mysqli_fetch_array($querychefcito))
  {
       ...
       $contraseña = $mostrar['contraseña'];
        ...
        echo"<center>";
        echo "<td><a class='btn btn-outline-success' href=\"admin/modificarUsuarioadmin.php?emailModUsu=$emailUsuario\">Modificar</a>";
        echo "<th><a class='btn btn-outline-success'href =\"admin/eliminarusuario.php?emailModUsu=$emailUsuario\"onClick=\"return confirm('¿Estas seguro de eliminar a $numeroTelefono?')\">Eliminar</a></th>" ;
        echo"</center>";
